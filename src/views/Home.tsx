...
export default function Hero() {
  ...
  // Fungsi smooth scroll ke section berikutnya (misal: Sejarah / Eksplorasi)
  ...
  return (
    <>
      <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-[#050810]">
        
        {/* ========================================================================= */}
        {/* BACKGROUND IMAGE TERANG DARI FOLDER PUBLIC                                */}
        {/* ========================================================================= */}
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Gradient overlay halus untuk meningkatkan kontras teks di sebelah kiri dan kanan */}
        ...
        {/* ========================================================================= */}
        {/* SIDEBAR SOSIAL MEDIA (KIRI) DENGAN BRAND HOVER COLORS                    */}
        {/* ========================================================================= */}
        <div className="absolute left-6 md:left-10 top-1/2 -translate-y-1/2 z-20 hidden sm:flex flex-col items-center gap-6 text-white">
          ...
          {/* Instagram (Merah/Pink #E4405F) */}
          <a 
            href="https://instagram.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#ff0184] hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(228,64,95,0.8)]"
            aria-label="Instagram"
          >
            <InstagramIcon size={22} />
          </a>

          {/* Facebook (Biru #1877F2) */}
          <a 
            href="https://facebook.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#1877F2] hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(24,119,242,0.8)]"
            aria-label="Facebook"
          >
            <FacebookIcon size={22} />
          </a>

          {/* TikTok (Cyan #00f2fe & Pink Glow agar terlihat di BG gelap) */}
          <a 
            href="https://tiktok.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#ffffff] hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(255,0,80,0.9)]"
            aria-label="TikTok"
          >
            <TikTokIcon size={22} />
          </a>

          {/* YouTube (Merah #FF0000) */}
          <a 
            href="https://youtube.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#FF0000] hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(255,0,0,0.8)]"
            aria-label="YouTube"
          >
            <YoutubeIcon size={22} />
          </a>
          
          {/* Garis Vertikal & Indikator Titik */}
        ...
        {/* ========================================================================= */}
        <div className="relative z-10 container mx-auto px-6 sm:pl-24 md:pl-28 lg:px-24 pt-20 flex flex-col lg:flex-row items-center justify-between gap-12 w-full">
          ...
          <div className="max-w-xl text-left w-full">
            <ScrollReveal>
              ...
              <h1 className="text-6xl sm:text-7xl md:text-8xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-100 via-yellow-300 to-yellow-500 tracking-tight leading-none mb-6 drop-shadow-[0_4px_15px_rgba(0,0,0,0.9)]">
                KOMODO
              </h1>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <p className="text-slate-200 text-sm sm:text-base leading-relaxed mb-8 drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] font-medium max-w-lg">
                Welcome to ORAHA, your gateway to the wonders of Komodo Island. Explore breathtaking 
                landscapes, rich marine biodiversity, and authentic local culture while embracing 
                sustainable tourism.
              </p>
            </ScrollReveal>
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-4 sm:gap-6 w-full sm:w-auto self-end lg:self-center mr-0 md:mr-6">
            ...
            <ScrollReveal delay={300}>
              ...
              >
                ...
                <h4 className="text-yellow-400 font-bold text-sm mb-1">Video:</h4>
                <p className="text-slate-200 text-xs font-medium leading-snug">
                  The Charm of Komodo<br/>
                  <span className="text-slate-400 text-[11px] font-normal">Witness the beauty of Komodo up close.</span>
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={500}>
              <div className="w-full sm:w-64 bg-black/40 backdrop-blur-md border border-white/15 p-5 rounded-2xl shadow-xl flex flex-col items-center text-center">
                ...
                <span className="text-slate-300 text-xs font-medium uppercase tracking-wider block mb-0.5">Today's Weather</span>
        ...
        {/* ========================================================================= */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center cursor-pointer group" onClick={scrollToNextSection}>
      ...
      {isVideoModalOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-lg animate-in fade-in duration-300">
          <div className="relative w-full max-w-4xl bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-[0_0_50px_rgba(0,0,0,0.9)] aspect-video">
            ...
            {/* Pemutar Video dari Path /Home/komodo.mp4 */}
            <video 
              autoPlay 
              controls 
              playsInline 
